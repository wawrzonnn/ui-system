...
export var Default = function () { return (React.createElement(Tabs, { defaultOpenedId: "tab-1" },
    ...
    React.createElement(TabContent, { id: "tab-1" }, "Content for Tab Breakfast"),
    React.createElement(TabContent, { id: "tab-2" }, "Content for Tab Lunches"),
    React.createElement(TabContent, { id: "tab-3" }, "Content for Tab Brunches"),
