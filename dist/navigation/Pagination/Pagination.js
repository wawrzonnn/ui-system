...
var Pagination = function (_a) {
      ...
      if (
        ...
        pages.push(
          React.createElement(
            ...
            {
              className: ""
                .concat(styles.paginationItem, " ")
                .concat(activePage === i && styles.activePage),
              onClick: function () {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      {
        className: ""
          .concat(styles.buttonPrev, " ")
          .concat(activePage === 1 && styles.buttonDisabled),
        onClick: handlePrev,
      },
    ...
    React.createElement(
      ...
      {
        className: ""
          .concat(styles.buttonNext, " ")
          .concat(activePage === maxPages && styles.buttonDisabled),
        onClick: handleNext,
      },
