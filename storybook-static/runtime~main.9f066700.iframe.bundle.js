(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (({
        177: "data-display-Avatar-Avatar-stories",
        201: "navigation-Stepper-Stepper-stories",
        231: "inputs-Checkbox-Checkbox-stories",
        242: "data-display-List-List-stories",
        280: "navigation-Tabs-Tabs-stories",
        391: "data-display-Table-Table-stories",
        427: "inputs-Switch-Switch-stories",
        511: "surface-components-Accordion-Accordion-stories",
        528: "inputs-TextField-TextField-stories",
        677: "navigation-Pagination-Pagination-stories",
        697: "surface-components-Card-Card-stories",
        774: "inputs-Button-Button-stories",
        856: "navigation-Link-Link-stories",
      }[chunkId] || chunkId) +
      "." +
      {
        58: "e0d5db37",
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute("data-webpack") == "ui-system:" + key
            ) {
              script = s;
              break;
            }
        ...
        script ||
          ...
          script.setAttribute("data-webpack", "ui-system:" + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkui_system =
          self.webpackChunkui_system || []);
