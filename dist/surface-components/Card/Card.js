...
export var Card = function (_a) {
    var fullWidth = _a.fullWidth, children = _a.children;
    var cardClasses = cx({
...
export var CardImage = function (_a) {
    ...
    return React.createElement("img", { src: url, alt: alt, className: styles.cardImage });
};
export var CardContent = function (_a) {
    var children = _a.children;
    return React.createElement("div", { className: styles.cardContent }, children);
};
